    ...
    return (
        ...
        >
            ...
            <div>                
                ...
                <br></br>
                <br></br>
                <strong>Donations</strong> Donors like you are a valuable part of our community here at BAICD. We’re all volunteers, but we aspire to pay our members and collaborators equitable market rates, We can’t do that without your support.  You help us secure the innovative, equitable, and democratic traditional arts we all believe in. Thanks to our fiscal sponsor Shawl Anderson Dance Center (SADC), all donations to BAICD are tax-deductible. Please donate through SADC’s website <a className="donationLink" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ&ab_channel=RickAstley" target="_blank">here</a>.
            </div>
        </div>
    );
};
